...
class EnhancedLLMWebScraper(WebScraper):
    ...
    def __init__(self, 
        ...
        Args:
            provider: The LLM provider to use (OLLAMA or LMSTUDIO)
        ...
        self.llm_provider = LLMProviderInterface.get_provider(provider, base_url, model_name)
    ...
    async def analyze_with_llm(self, content: str, prompt: str) -> str:
        """Analyze content with local LLM using provider interface
